if ! ssh -i /home/pi/aws_micro_ubuntu.pem ubuntu@ec2-18-218-34-216.us-east-2.compute.amazonaws.com -t 'timeout 5 ssh -p 10022 pi@localhost exit'; then
	ssh -i /home/pi/aws_micro_ubuntu.pem ubuntu@ec2-18-218-34-216.us-east-2.compute.amazonaws.com -t 'sudo kill -9 $(sudo lsof -t -i:10022) && sudo systemctl restart ssh' || true
	sleep 5
